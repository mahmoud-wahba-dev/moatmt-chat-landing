  ...
  return (
    <section className=" overflow-hidden">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 hero-content w-full max-w-full flex-col lg:flex-row gap-24 max-sm:gap-9">
          <div className="max-sm:order-2">
            <div>
              ...
              <h1 className="font-bold  text-64px leading-[80px] text-[#101010] mb-6 max-sm:text-32px max-sm:text-center max-sm:leading-[40px]">
                مؤتمـــــــت شات تواصل أسهل
                <br />
                لا تضيــــــــع وقتــــــــك، تواصل فــــــــورًا
              </h1>

              <p className="font-medium text-22px  text-dark-black mb-11 max-sm:text-center max-sm:text-14px">
                منصة موحدة لخدمة العملاء جمعت لك مختلف وسائل التواصل بمكان
                واحدمن لوحة تحكُّم واحدة!
              </p>
              <div className="flex items-center gap-7 mb-10 max-sm:flex-wrap max-sm:justify-center ">
                <BtnSubscribe
                  content="انشئ حسابك الان"
                  className="text-white bg-primary max-sm:w-w-[80%] max-sm:h-[56px]"
          ...
          <div className="hover-3d max-sm:order-1">
